export function InstagramButton({ url }: { url: string }) {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-20 flex h-14 w-14 items-center justify-center rounded-full shadow-lg shadow-black/20 transition-transform hover:-translate-y-0.5 hover:shadow-xl sm:bottom-6 sm:right-6"
      style={{
        background:
